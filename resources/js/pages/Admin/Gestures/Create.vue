...
import { ArrowLeft, Save, Info, CheckCircle, AlertCircle } from 'lucide-vue-next'
...
const submit = () => {
  form.post('/admin/gestures')
}
</script>

<template>
  <Head title="Create Gesture" />
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
          <div class="flex items-center">
            ...
            <div>
              <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Create Gesture</h1>
              <p class="text-gray-600 mt-1">Add a new sign language gesture to your dataset</p>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-2xl">
          ...
          <Card class="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
            <CardHeader class="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
              ...
              <CardDescription class="text-gray-600">
                Enter the gesture information below. All fields marked with * are required.
              </CardDescription>
            </CardHeader>
              ...
              <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="flex items-center justify-end space-x-4 pt-8 border-t border-gray-200">
                  ...
                  <Button 
                    ...
                    class="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl transition-all duration-200 min-w-[140px]"
                  >
                    <Save class="w-4 h-4 mr-2" />
                    {{ form.processing ? 'Creating...' : 'Create Gesture' }}
                  </Button>
                </div>
              </form>
            </CardContent>
          ...
          <!-- Help Card -->
          <Card class="mt-6 border-0 shadow-sm bg-gradient-to-r from-blue-50 to-indigo-50">
              ...
              <div class="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul class="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• Labels should be user-friendly and clear</li>
                    <li>• Add detailed descriptions to help with training consistency</li>
                    <li>• Keep gestures active only when ready for use</li>
                  </ul>
                </div>
              </div>
            </CardContent>
